...
const TrainingDetails = () => {
    ...
    setLoading(true);
    axios
      .get(`${import.meta.env.VITE_APITR}/atraining/${id}`)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    const fetchClickCount = async () => {
      const response = await fetch(`${import.meta.env.VITE_APITR}/get-clicks/${id}`);
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_APITR}/${id}/shares`)
      .then((response) => {
  ...
  const handleShareClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_APITR}/${id}/shares`
      );
   ...
   const handleAddComment = () => {
    ...
    axios
      .post(`${import.meta.env.VITE_APITR}/${id}/comments`, comment)
      .then(() => {})
