...
const BookDetails = () => {
  ...
  useEffect(() => {
    ...
    axios
    .get(`${import.meta.env.VITE_APIB}/abookshop/${id}`)
    .then((response) => {
...
const handleMapClick = (address) => {
  ...
  useEffect(() => {
    ...
    const fetchClickCount = async () => {
      const response = await fetch(`${import.meta.env.VITE_APIB}/get-clicks/${id}`);
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_APIB}/${id}/shares`)
      .then((response) => {
  ...
  const handleShareClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_APIB}/${id}/shares`
      );
  ...
  const handleAddComment = () => {
    ...
    axios
      .post(`${import.meta.env.VITE_APIB}/${id}/comments`, comment)
      .then(() => {})
...
<div className="flex flex-col space-y-6">
 ...
 <h2 className="text-gray-700">
              <span className="font-bold">Bookshop or Library:</span> {school.BookOrLibrary}
            </h2>
