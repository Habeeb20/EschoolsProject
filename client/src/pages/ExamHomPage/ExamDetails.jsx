...
const ExamDetails = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${import.meta.env.VITE_APIE}/anexam/${id}`)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    const fetchClickCount = async () => {
      const response = await fetch(`${import.meta.env.VITE_APIE}/get-clicks/${id}`);
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_APIE}/${id}/shares`)
      .then((response) => {
  ...
  const handleShareClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_APIE}/${id}/shares`
      );
  ...
  const handleAddComment = () => {
    ...
    axios
      .post(`${import.meta.env.VITE_APIE}/${id}/comments`, comment)
      .then(() => {})
